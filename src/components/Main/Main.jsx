      ...
      <div className="main">
        ...
        <div className="main-container">
          {!showResult ? (
            <>
              ...
              <div className="cards">
                ...
                <div className="card">
                  <p>Write a code for me in any programming languages</p>
            ...
            <div className="result">
              <div className="result-title">
                <img src={assets.brahma} alt="UserIcon" />
                <p>{recentPrompt}</p>
              </div>
              <div className="result-data">
                <img src={assets.logox} alt="" />
                {loading ? (
          ...
          <div className="main-bottom">
            ...
            <p>
							GenX may display inaccurate info, including about people, so
							double-check its responses. Your privacy & GenX Apps
						</p>
                        <p>
                            The Creator of this AI Model is Chitransh Shukla @GenX corporation 2024
                        </p>
            </p>
          </div>
        </div>
